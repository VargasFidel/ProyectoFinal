...
@WebServlet(name = "LaboratorioControlador", urlPatterns = {"/LaboratorioControlador"})
public class LaboratorioControlador extends HttpServlet {
        ...
        try {
            ...
            switch (action) {
                ...
                case "delete":
                    id = Integer.parseInt(request.getParameter("id_producto"));
                    dao.delete(id);
                    response.sendRedirect("LaboratorioControlador");
                    break;
                case "view":
